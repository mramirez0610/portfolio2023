exports.id = "component---src-pages-projects-mdx-frontmatter-slug-js-content-file-path-src-content-projs-proj-3-mdxhead";
exports.ids = ["component---src-pages-projects-mdx-frontmatter-slug-js-content-file-path-src-content-projs-proj-3-mdxhead"];
exports.modules = {
...
function _createMdxContent(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h1, null, "Data Application"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "This project was my first dive into the power of React, a popular JavaScript library for building user interfaces, for a comprehensive project. The task at hand was to develop a data-driven application that could efficiently process a JSON file and transform it into an interactive, user-friendly application."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "The primary functionality of the application was to serve as a music player, providing the user with the ability to select and play songs at their convenience. It also presented valuable data about the album from which the song originated, as well as information about the artist, thereby enriching the user's experience and providing them with a deeper understanding of their music selection."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "One of the significant learning outcomes from this project was gaining a profound understanding of state management in React. State management was a critical aspect of this project as it was extensively used to navigate between different albums, thereby ensuring a smooth and seamless user experience."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.p, null, "In summary, this project was not just about building a music player; it was a comprehensive exercise in understanding and implementing state management in React, processing JSON data, and enhancing user experience by providing valuable data about the music being played."), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.h2, null, "Technology Used"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.ul, null, "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "React"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "React Router"), "\n", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components.li, null, "Converting JSON into interactive elements"), "\n"));
}
...
/***/ "./src/pages/projects/{mdx.frontmatter__slug}.js?__contentFilePath=/Users/marco/Documents/personalProjs/portfolio/src/content/projs/proj3.mdx&export=head":
/*!****************************************************************************************************************************************************************!*\
  !*** ./src/pages/projects/{mdx.frontmatter__slug}.js?__contentFilePath=/Users/marco/Documents/personalProjs/portfolio/src/content/projs/proj3.mdx&export=head ***!
  \****************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Users_marco_Documents_personalProjs_portfolio_src_content_projs_proj3_mdx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/content/projs/proj3.mdx */ "./src/content/projs/proj3.mdx");
...
function GatsbyMDXWrapper(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(Project, props, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_Users_marco_Documents_personalProjs_portfolio_src_content_projs_proj3_mdx__WEBPACK_IMPORTED_MODULE_0__["default"], props));
}
...
;
//# sourceMappingURL=component---src-pages-projects-mdx-frontmatter-slug-js-content-file-path-src-content-projs-proj-3-mdxhead.js.map